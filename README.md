...
![SRJ20 partial BGA breakout sample001](docs/sample.svg)

Regenerate it with `npm run generate:readme-image`.
...
`npm run build:site` exports the same browser to `cosmos-export/`, the output
directory configured for Vercel.
